...
RegExp("(\\/|\\.|\\*|\\+|\\?|\\||\\(|\\)|\\[|\\]|\\{|\\}|\\\\)","g");return a.replace(arguments.callee.sRE,"\\$1")},find:function(a,b){var a=this.trim(a),c;b[a]===false||b[a]===0||b[a]?c=b[a]:(this.context[a]===false||this.context[a]===0||this.context[a])&&(c=this.context[a]);return typeof c==="function"?c.apply(b):c!==void 0?c:""},includes:function(a,b){return b.indexOf(this.otag+a)!=-1},escape:function(a){return String(a===null?"":a).replace(/&(?!\w+;)|["'<>\\]/g,function(a){switch(a){case "&":return"&amp;";
...
"function")return a.map(b);else{for(var c=[],d=a.length,e=0;e<d;e++)c.push(b(a[e]));return c}},getCachedRegex:function(a,b){var c=g[this.otag];c||(c=g[this.otag]={});var d=c[this.ctag];d||(d=c[this.ctag]={});(c=d[a])||(c=d[a]=b(this.otag,this.ctag));return c}};return{name:"mustache.js",version:"0.4.0-dev",to_html:function(a,b,c,d){var e=new m;if(d)e.send=d;e.render(a,b||{},c);if(!d)return e.buffer.join("\n")}}}();
